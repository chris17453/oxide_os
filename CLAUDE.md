...
- Fork sysretq CLI: `docs/agents/fork-sysretq-cli-requirement.md` (manual sysretq/iretq MUST cli before touching RSP — timer ISR has no IST, pushes frame onto current RSP, corrupts scheduler if RSP points to user memory).
