...
pub extern "C" fn sinhf(x: f32) -> f32 {
    math::sinh(x as f64) as f32
}
#[unsafe(no_mangle)]
pub extern "C" fn coshf(x: f32) -> f32 {
    math::cosh(x as f64) as f32
}
#[unsafe(no_mangle)]
pub extern "C" fn tanhf(x: f32) -> f32 {
    math::tanh(x as f64) as f32
}
...
#[unsafe(no_mangle)]
pub extern "C" fn fabsl(x: f64) -> f64 {
    math::fabs(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn ceill(x: f64) -> f64 {
    math::ceil(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn floorl(x: f64) -> f64 {
    math::floor(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn roundl(x: f64) -> f64 {
    math::round(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn truncl(x: f64) -> f64 {
    math::trunc(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn sqrtl(x: f64) -> f64 {
    math::sqrt(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn logl(x: f64) -> f64 {
    math::ln(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn log10l(x: f64) -> f64 {
    math::log10(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn log2l(x: f64) -> f64 {
    math::log2(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn expl(x: f64) -> f64 {
    math::exp(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn powl(x: f64, y: f64) -> f64 {
    math::pow(x, y)
}
#[unsafe(no_mangle)]
pub extern "C" fn fmodl(x: f64, y: f64) -> f64 {
    math::fmod(x, y)
}
#[unsafe(no_mangle)]
pub extern "C" fn copysignl(x: f64, y: f64) -> f64 {
    math::copysign(x, y)
}
#[unsafe(no_mangle)]
pub extern "C" fn sinl(x: f64) -> f64 {
    math::sin(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn cosl(x: f64) -> f64 {
    math::cos(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn tanl(x: f64) -> f64 {
    math::tan(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn asinl(x: f64) -> f64 {
    math::asin(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn acosl(x: f64) -> f64 {
    math::acos(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn atanl(x: f64) -> f64 {
    math::atan(x)
}
#[unsafe(no_mangle)]
pub extern "C" fn atan2l(y: f64, x: f64) -> f64 {
    math::atan2(y, x)
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn frexpl(x: f64, exp: *mut i32) -> f64 {
    frexp(x, exp)
}
#[unsafe(no_mangle)]
pub extern "C" fn ldexpl(x: f64, exp: i32) -> f64 {
    math::ldexp(x, exp)
}
#[unsafe(no_mangle)]
