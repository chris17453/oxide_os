...
pub fn parse_terminfo_binary(data: &[u8]) -> Result<TerminalEntry, &'static str> {
    ...
    let names_str = core::str::from_utf8(names_bytes).map_err(|_| "Invalid UTF-8 in names")?;
    ...
    for i in 0..str_count {
        ...
        let str_offset =
            u16::from_le_bytes([data[str_offset_pos], data[str_offset_pos + 1]]) as usize;
...
const BOOL_CAP_NAMES: &[&str] = &[
    ...
    "ndscr", "ccc", "bce", "hls", "xhpa", "crxm", "daisy", "xvpa", "sam", "cpix", "lpix", "OTcr",
    "OTcu", "OTbs",
];
...
const STR_CAP_NAMES: &[&str] = &[
    ...
    "kf6", "kf7", "kf8", "kf9", "khome", "kich1", "kcub1", "kll", "knp", "kpp", "kcuf1", "kind",
    "kri", "khts", "kcuu1", "rmkx", "smkx", "lf0", "lf1", "lf10", "lf2", "lf3", "lf4", "lf5",
    "lf6", "lf7", "lf8", "lf9", "rmm", "smm", "nel", "pad", "dch", "dl", "cud", "ich", "indn",
    "il", "cub", "cuf", "rin", "cuu", "pfkey", "pfloc", "pfx", "mc0", "mc4", "mc5", "rep", "rs1",
    "rs2", "rs3", "rf", "rc", "vpa", "sc", "ind", "ri", "sgr", "hts", "wind", "ht", "tsl", "uc",
    "hu", "iprog", "ka1", "ka3", "kb2", "kc1", "kc3", "mc5p", "rmp", "acsc", "pln", "kcbt",
