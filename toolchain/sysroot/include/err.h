/* OXIDE OS err.h — BSD-style error message functions */
...
void verr(int eval, const char *fmt, va_list args) __attribute__((noreturn));
void verrx(int eval, const char *fmt, va_list args) __attribute__((noreturn));
