...
create-rootfs: increment-build kernel bootloader userspace-release archive-kernel initramfs userspace-std
	...
	for prog in gwbasic curses-demo tls-test thread-test dyntest dynlink-test dynlink-ncurses-test dynlink-suite mmap-write-test shm-test shm-fork-test ipc-suite iconv-test dns-resolver-test unix-socket-test gtk-hello gtk-simple wayland-connect-test oxide-wayland oxide-dbusd ssh sshd rdpd service networkd resolvd sntpd journald journalctl evtest argtest $(COREUTILS_BINS) testcolors; do \
