...
CFLAGS=$(echo "-O2 -fno-pic -march=x86-64 -mtune=generic -mno-avx -mno-avx2 -I/home/cwatkins/repos/cw/oxide_os/toolchain/sysroot/include -DHAVE_LANGINFO_H=1 -DHAVE_ZLIB_H=1" | sed "s#$prefix#$prefix_real#")
VERSION="3.13"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
