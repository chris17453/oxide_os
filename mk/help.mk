...
help:
	...
	@echo ""
	@echo "Autonomous GDB Debugging:"
	@echo "  debug-server      - Start QEMU with GDB server (manual attach)"
	@echo "  debug-capture     - Capture crash/panic automatically"
	@echo "  debug-boot-check  - Quick boot sanity check"
	@echo "  debug-exec        - Execute GDB command (usage: make debug-exec CMD='bt')"
	@echo "  debug-repl        - Interactive autonomous GDB REPL"
	@echo "  Or: ./scripts/debug-kernel.sh <capture|boot|exec|repl>"
	@echo ""
	@echo "Build Targets:"
