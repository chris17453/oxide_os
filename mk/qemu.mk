...
.PHONY: detect-qemu-mode kill-qemu run run-fedora run-rhel run-kvm run-debug-input-gui run-debug-mouse run-debug-lock run-debug-fork run-debug-sched run-debug-all
