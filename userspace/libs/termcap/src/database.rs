...
fn xterm() -> TerminalEntry {
    ...
    entry.set_string(strings::SET_ATTRIBUTES, "\x1b[0%?%p6%t;1%;%?%p2%t;4%;%?%p1%p3%|%t;7%;%?%p4%t;5%;m");
    ...
    entry.set_string(strings::ACS_CHARS, "``aaffggiijjkkllmmnnooppqqrrssttuuvvwwxxyyzz{{||}}~~");
